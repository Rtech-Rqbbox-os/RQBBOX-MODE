const Settings = {
    ...
    return `
      <div class="settings-panel">
        ...
        <div class="settings-row">
          <div><div class="settings-label">RQBBOX Experience OS 1.0</div><div class="settings-desc">Enable the full-screen gaming experience</div></div>
  ...
  startupPanel() {
    ...
    return `
      <div class="settings-panel">
        <h3>🚀 Startup & Boot</h3>
        <div class="settings-row">
          <div><div class="settings-label">Boot to RQBBOX Experience OS 1.0</div><div class="settings-desc">Automatically enter gaming mode on startup</div></div>
  ...
  windowsPanel() {
    return `
      <div class="settings-panel">
        ...
        <p style="font-size:0.8rem;color:var(--text-secondary);margin-bottom:16px;">
          Integrate RQBBOX Experience OS 1.0 with Windows Gaming Settings, Game Bar, and Game Mode.
        </p>
        <div class="settings-row">
          <div>
        ...
        <div class="settings-row">
          <div>
            ...
            <div class="settings-desc">rqbbox:// protocol — open RQBBOX Experience OS 1.0 from any browser</div>
          </div>
        ...
        <div class="settings-row">
          <div>
            ...
            <div class="settings-desc">Launch RQBBOX Experience OS 1.0 from Windows Start Menu</div>
          </div>
      ...
      <div class="settings-panel">
        ...
        <p style="font-size:0.8rem;color:var(--text-secondary);margin-bottom:16px;">
          Run the installer to fully integrate RQBBOX Experience OS 1.0 into Windows Gaming Settings.
        </p>
  ...
  installShortcut() {
    ...
    Notifications.add('Shortcut Created', 'RQBBOX Experience OS 1.0 added to Start Menu', '📌');
  },
  ...
  runInstaller() {
    RQBOX.openModal(`
      <h3>📦 Install RQBBOX Experience OS 1.0 to Windows</h3>
