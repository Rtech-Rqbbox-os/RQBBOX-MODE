...
/**
 * RQBBOX Experience OS 1.0 - Entry Point
...
function main() {
  console.log('');
  console.log('  ==============================');
  console.log('   RQBBOX Experience OS 1.0 - Gaming Console');
  ...
  process.on('SIGINT', () => {
    console.log('\nShutting down RQBBOX Experience OS 1.0...');
    server.kill();
    process.exit(0);
  });
