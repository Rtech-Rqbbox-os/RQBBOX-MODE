# RQBBOX Experience OS 1.0 - Windows Gaming Settings Integration Guide

## Overview

This guide explains how to integrate RQBBOX Experience OS 1.0 into Windows Settings under the Gaming section. Once configured, RQBBOX Experience OS 1.0 will appear as a system gaming application with full settings management through Windows Settings.
...
1. **Navigate to the installation folder:**
   ```
   RQBBOX Experience OS 1.0\windows\scripts\
   ```
...
2. **Navigate to scripts directory:**
   ```powershell
   cd "C:\Users\YourUsername\Downloads\RQBBOX Experience OS 1.0\windows\scripts"
   ```
...
1. **Navigate to:**
   ```
   RQBBOX Experience OS 1.0\windows\
   ```
...
```
Settings > Gaming > RQBBOX Experience OS 1.0
```
...
If you want to remove RQBBOX Experience OS 1.0 from Gaming Settings:
...
$TaskPath = "\RQBBOX Experience OS 1.0\"
...
- **Server Port:** 19778
- **Node.js Required:** Yes (included with RQBBOX Experience OS 1.0)
...
5. ✅ Launch RQBBOX Experience OS 1.0 from the Start Menu
6. ✅ Enjoy console gaming on PC!

---

**Questions?** Check the main RQBBOX Experience OS 1.0 README.md for additional support.
