# RQBBOX Experience OS 1.0 - Windows Integration Files

This folder contains all Windows-related configuration files and scripts for integrating RQBBOX Experience OS 1.0 with Windows Gaming Settings.
...
**What it does:**
- Registers RQBBOX Experience OS 1.0 in Windows Gaming Settings
...
cd "C:\Path\to\RQBBOX Experience OS 1.0\windows\scripts"
...
5. Your RQBBOX Experience OS 1.0 app remains installed

**Note:** This only removes gaming integration settings, not the RQBBOX Experience OS 1.0 application itself.
...
- ✅ Integrates with RQBBOX Experience OS 1.0
...
### Windows Settings
Located at: `Settings → Gaming → RQBBOX Experience OS 1.0`
...
### Capture Folder
Default location: `RQBBOX Experience OS 1.0\captures\`
...
3. Find "RQBBOX Experience OS 1.0"
4. Configure your preferences

### Launch RQBBOX Experience OS 1.0
1. Search for "RQBBOX Experience OS 1.0" in Start Menu
2. Or run: `Launch RQBBOX Experience OS 1.0.bat`
3. Or open: `http://127.0.0.1:19778/dashboard`

### Change Performance Profile
1. Settings → Gaming → RQBBOX Experience OS 1.0
2. Select profile: Balanced, Maximum, or Quality
3. Changes apply immediately

### Configure Controller
1. Settings → Gaming → RQBBOX Experience OS 1.0 → Controller
...
### Regular Updates
Check for updates to RQBBOX Experience OS 1.0 via:
- Start Menu → RQBBOX Experience OS 1.0 → Check for Updates
...
3. **Verify:** Open Settings → Gaming → RQBBOX Experience OS 1.0
4. **Configure:** Adjust settings to your preference
5. **Launch:** Start RQBBOX Experience OS 1.0 and enjoy!
...
- **Node.js:** v18+ (included with RQBBOX Experience OS 1.0)

---

## 📝 License

RQBBOX Experience OS 1.0® is a proprietary application.
"Plug Into Gaming." ® is a registered trademark.

All files in this folder are part of RQBBOX Experience OS 1.0 and are subject to the license agreement.
