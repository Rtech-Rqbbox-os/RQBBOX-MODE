# ✅ RQBBOX MODE - Installation Verification Checklist

Use this checklist to verify that RQBBOX MODE has been successfully integrated into Windows Gaming Settings.
...
- [ ] RQBBOX MODE application installed
...
- [ ] Navigated to: `RQBBOX MODE\windows\scripts\`
...
3. Look for: **RQBBOX MODE** section

- [ ] Windows Settings app opens
- [ ] Gaming section accessible
- [ ] RQBBOX MODE appears in Gaming
...
In Windows Settings > Gaming > RQBBOX MODE > Game Mode:
...
In Windows Settings > Gaming > RQBBOX MODE > Performance Mode:
...
In Windows Settings > Gaming > RQBBOX MODE > Controller:
...
### Step 13: Launch RQBBOX MODE
Try to launch RQBBOX MODE:
- [ ] Search for "RQBBOX MODE" in Start Menu
...
1. Navigate to: `RQBBOX MODE\captures\`
...
In Windows Settings > Gaming > RQBBOX MODE:
...
- [ ] RQBBOX MODE appears in Windows Settings Gaming
...
- ✅ RQBBOX MODE visible in Windows Settings
...
**Issue: Windows Settings not showing RQBBOX MODE?**
...
2. [ ] Launch RQBBOX MODE from Start Menu
...
- [ ] Windows Settings show RQBBOX MODE
- [ ] All configuration sections accessible
- [ ] Game Mode functioning
- [ ] Game DVR working
- [ ] Controller settings configured
- [ ] Capture folder created
- [ ] RQBBOX MODE launches successfully
- [ ] Ready to use!
...
RQBBOX MODE is now fully integrated into Windows Gaming Settings!
