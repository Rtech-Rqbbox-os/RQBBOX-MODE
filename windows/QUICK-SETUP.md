# RQBBOX MODE - Windows Gaming Settings Quick Setup
...
```
Settings → Gaming → Find "RQBBOX MODE"
```
...
### Option 1: Start Menu
Search for "RQBBOX MODE" → Click to launch

### Option 2: Batch File
```
Launch RQBBOX MODE.bat
```
...
├── Launch RQBBOX MODE.bat                (Launch app)
...
To remove RQBBOX MODE Gaming Settings:
...
**Note:** This only removes gaming settings, not the RQBBOX MODE application.
...
- **Node.js** (included with RQBBOX MODE)
...
4. ✅ Launch RQBBOX MODE
5. ✅ Start gaming!

**Enjoy console gaming on PC with RQBBOX MODE!** 🚀
