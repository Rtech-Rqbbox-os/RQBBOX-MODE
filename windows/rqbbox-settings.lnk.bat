@echo off
:: RQBBOX Experience OS 1.0 - Windows Settings Launcher
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
    ...
    "$lnk = $ws.CreateShortcut(\"$desktop\RQBBOX Experience OS 1.0 Settings.lnk\");" ^
    "$lnk.TargetPath = 'cmd.exe';" ^
    "$lnk.Arguments = '/c start http://127.0.0.1:19778/windows-settings.html';" ^
    "$lnk.WorkingDirectory = '%~dp0\..';" ^
    "$lnk.Description = 'RQBBOX Experience OS 1.0 - Windows Gaming Settings';" ^
    "$lnk.Save();" ^
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
    ...
    "$lnk = $ws.CreateShortcut(\"$folder\RQBBOX Experience OS 1.0 Settings.lnk\");" ^
    "$lnk.TargetPath = 'cmd.exe';" ^
    "$lnk.Arguments = '/c start http://127.0.0.1:19778/windows-settings.html';" ^
    "$lnk.WorkingDirectory = '%~dp0\..';" ^
    "$lnk.Description = 'RQBBOX Experience OS 1.0 - Windows Gaming Settings';" ^
...
echo.
echo Shortcuts created! You can find RQBBOX Experience OS 1.0 Settings:
echo   - Desktop
